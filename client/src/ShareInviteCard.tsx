  ...
  return (
    <div className={embedded ? 'share-card share-card--embedded' : 'card share-card'}>
      ...
      <p className="muted share-card-intro">
        ...
        Attach <span className="share-pdf-name">{pdfName}</span> from your computer; VeriLock never
        hosts the file.
      </p>
      ...
      <p className="muted share-option-detail share-email-hint">
        <strong>Send email</strong> opens your mail app with the signing link and instructions.
        Remember to attach your agreement document (
        <span className="share-pdf-name">{pdfName}</span>) — VeriLock never hosts the file.
      </p>
