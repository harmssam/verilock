...
export const post: BlogPost = {
  ...
  body: [
    ...
    {
      type: 'p',
      text: 'On the home screen, pick Create & invite to start, I was invited to co-sign, or Verify a file to check a locked proof. For a shorter walkthrough of signing only, see How to Sign a PDF with Blockchain. For the product definition and limits, see What is VeriLock.',
    },
    {
      type: 'p',
