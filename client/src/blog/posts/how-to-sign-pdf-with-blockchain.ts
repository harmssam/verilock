...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      type: 'ul',
      items: [
        'On the home screen, choose Create & invite (or open an in-progress agreement).',
    ...
    {
      type: 'p',
      text: 'Ready to lock a fingerprint? Through the end of July, a permanent Nimiq on-chain lock is 500 NIM (50% off the 1000 NIM list price). Promo ends August 1.',
    },
  ],
}
