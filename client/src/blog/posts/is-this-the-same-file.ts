...
export const post: BlogPost = {
  ...
  body: [
    ...
    {
      type: 'p',
      text: 'Sign free. Lock when it matters. Through the end of July, a permanent Nimiq on-chain lock is 500 NIM (50% off the 1000 NIM list price). Promo ends August 1.',
    },
  ],
}
