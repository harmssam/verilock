...
export const post: BlogPost = {
  ...
  description:
    'Check a locked VeriLock agreement by fingerprinting a PDF in the browser. Basic integrity needs no wallet.',
  date: '2026-07-09',
  tags: ['guide', 'verify'],
  coverImage: cover,
  ...
  body: [
    {
      type: 'p',
      text: 'Not everyone who needs proof should need a crypto wallet. Counterparties, counsel, auditors, or a future you may only need one answer: is this PDF still the locked version? VeriLock\'s verify path is built for that.',
    },
    {
      type: 'p',
    ...
    },
    {
      ...
      caption: 'Integrity check: browser, PDF, locked record. Nothing else required.',
    },
    {
      type: 'h2',
    ...
    {
      type: 'p',
      text: 'Verification re-runs the hash math. It compares the fingerprint of the file you hold to the fingerprint that was locked on the blockchain. A match means the bytes still align with the permanent record. A mismatch means the file is not the locked document, even if the filename looks right.',
    },
    {
      type: 'p',
    ...
    },
    {
      type: 'ul',
      items: [
        'The PDF that was locked on the blockchain, or a candidate copy someone claims matches.',
    ...
    },
    {
      ...
      items: [
        ...
        'Read the result: match means integrity holds against the locked fingerprint; no match means the bytes differ.',
      ],
    },
    {
      type: 'p',
      text: 'Keep the locked PDF somewhere durable. Verification is only as useful as the file you still possess.',
    },
    {
      type: 'h2',
    ...
    },
    {
      ...
      caption: 'Signers and people who lock use wallets. Pure integrity checks do not.',
    },
    {
      type: 'ul',
      items: [
        'Connect a wallet when you need private signature details as a party.',
        'Creators locking a new fingerprint or buying credits need a wallet.',
        'Co-signers signing an in-progress agreement need a wallet.',
        'Someone who only asks "is this still the locked PDF?" does not.',
      ],
    },
    {
      type: 'h2',
    ...
    },
    {
      ...
      items: [
        ...
        'The file was edited after locking (even a tiny change).',
        'You never stored the locked copy and only have an older draft.',
      ],
    },
    {
      type: 'note',
      text: 'A match is strong evidence of byte integrity against the locked fingerprint. It is not a substitute for legal review, and it is not document forensics on files that were never locked.',
    },
    {
      type: 'h2',
      text: 'Privacy angle',
