...
4. **Do not invent fees.** Read live numbers from `client/src/sealPricing.ts` (and Pricing UI). As of July 2026: list **1000 NIM**, July promo **50% off → 500 NIM**, **promo ends August 1** (`isJulyPromoActive`: calendar month === July).
...
Style: restrained light-SaaS product photography, near-white #fafdfc with soft mint wash, teal accents only, warm gray props, large empty background, no text, no logos, no deep navy.
...
Style: restrained light product photography, near-white field, soft charcoal and off-white paper, teal accent only if needed, large empty space, no text, no logos.
...
- "Through the end of July, a permanent Nimiq on-chain lock is 500 NIM (50% off the 1000 NIM list price). Promo ends August 1."
- "Ready to lock a fingerprint on the blockchain? 500 NIM through July."

Article footer button should point at **Pricing** (or home create), with promo-aware label, not "Try it on verilock.online."

When the July promo ends, update this section and post closers so they do not promise 500 NIM.
