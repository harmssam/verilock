...
export function DocumentJourney({
  ...
  // VeriLock Easter egg: the one locked guest document renders as an image-only,
  // read-only view. Server also rejects every mutation targeting it (guestAuth.ts).
  if (doc?.source.easterEggLocked) {
    return (
      <div className="journey">
          ...
          <section className="action-dock" aria-live="polite">
            ...
            <div className="action-dock-body">
              <div className="result-banner result-banner--locked" role="status">
                ...
                <div>
                  <strong>{doc.source.title || doc.fileName}</strong>
              ...
              <div className="easter-egg-frame">
                <img
                  src="/easteregg.png"
                  alt={doc.source.title || doc.fileName}
